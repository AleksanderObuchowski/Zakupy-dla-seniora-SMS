...
board_view_parser.add_argument('latitude', required=True, type=float)
board_view_parser.add_argument('longitude', required=True, type=float)
board_view_parser.add_argument('radius', required=True, type=float)
